...
CREATE TABLE `tm_post` (
  ...
  `s_posturi` char(24) NOT NULL default '0' COMMENT 'Post URI',
  ...
  `tn_lang` tinyint(1) unsigned NOT NULL default '0' COMMENT 'Language Type',
  `i_timestamp` int(10) unsigned NOT NULL default '0' COMMENT 'Timestamp for post',
...
INSERT INTO `tm_post` (`i_postid`,`s_posturi`,`s_posttitle`,`dt_postdate`,`c_posttime`,`tb_post`,`tn_delflag`,`s_user`,`tn_lang`,`i_timestamp`) VALUES 
 (1,'200906021622132500000100','Test1','2009-06-02','16:21','With great courage, Iranians have been rising up against the tyranny of their 30-year-old Islamic Republic. This is a weak moment for Iran\'s terror-based regime, and democracies such as the U.S. should seize the chance to shake it further--and support the protesters in the process--by turning up the heat.',0,'cibech',0,3652),
 (2,'200906030802125400000202','テスト2','2009-06-03','08:02','単体ヒ素およびほとんどのヒ素化合物は、人体に非常に有害である。飲み込んだ際の急性症状は、消化管の刺激によって、吐き気、嘔吐、下痢、激しい腹痛などがみられ、場合によってショック状態から死に至る。慢性症状は、剥離性の皮膚炎や過度の色素沈着、骨髄障害、末梢性神経炎、黄疸、腎不全など。慢性ヒ素中毒による皮膚病変としては、ボーエン病が有名である。単体ヒ素及びヒ素化合物は、毒物及び劇物取締法により医薬用外毒物に指定されている。日中戦争中、旧日本軍では嘔吐性のくしゃみ剤ジフェニルシアノアルシンが多く用いられたが、これは砒素を含む毒ガスである。\r\n\r\nヒ素およびヒ素化合物は WHO の下部機関 IRAC より発癌性がある〔Type1〕と勧告されている。\r\n\r\n一方でヒ素化合物は人体内にごく微量が存在しており、生存に必要な微量必須元素であると考えられている[2][3]。ただしこれは、一部の無毒の有機ヒ素化合物の形でのことである。低毒性の、あるいは生体内で無毒化される有機ヒ素化合物にはメチルアルソン酸やジメチルアルシン酸などがあり、カキ、クルマエビなどの魚介類やヒジキなどの海草類に多く含まれる。さらにエビには高度に代謝されたアルセノベタインとして高濃度存在している。人体に必要な量はごく少なく自然に摂取されると考えられ、また少量の摂取でも毒性が発現するため、サプリメントとして積極的に摂る必要はない。\r\n\r\n亜ヒ酸を含む砒石は日本では古くから「銀の毒」、「石見銀山ねずみ捕り」などと呼ばれ殺鼠剤や暗殺などに用いられていた。',0,'cibech',2,11201),
 (3,'200908040802125600000302','テスト3','2009-08-04','08:02','宮崎県の高千穂町の山あい土呂久では、亜ヒ酸製造が行われていた。この地区の住民に現れた慢性砒素中毒症は、公害病に認定された。症状としては、暴露後数十年して、皮膚の雨だれ様の色素沈着や白斑、手掌、足底の角化、ボーエン病、およびそれに続発する皮膚癌、呼吸器系の肺癌、泌尿器系の癌がある。発生当時は、砒素を焼く煙がＶ字型の谷に低く垂れ込め、河川や空気を汚染したものと考えられた。上に記した症状は、特に広範な皮膚症状は、環境による慢性砒素中毒を考えるべき重要な症状である。この症状が重要であり、長年月経過すれば、病変、皮膚、毛髪、爪などには、砒素を検出しない。\r\n\r\n上流に天然の砒素化合物鉱床がある河川はヒ素で汚染されているため、高濃度の場合、流域の水を飲むことは服毒するに等しい自殺行為である。低濃度であっても蓄積するので、長期飲用は中毒を発症する。地熱発電の水も砒素を含むので、川に流されず、また、地下に戻される。慢性砒素中毒は、例えば井戸の汚染などに続発して、単発的に発生することもある。このような河川は中東など世界に若干存在する。砒素中毒で最も有名なのは台湾の例であり、足の黒化、皮膚癌が見られた。汚染が深刻な国バングラデシュでは、皮膚症状、呼吸器症状、内臓疾患をもつ患者が増えている。ガンで亡くなるケースも報告されている。中国奥地にもみられ、日本の皮膚科医が調査している。',0,'cibech',2,17589),
 (2,'200907021722698500000200','Test2','2009-07-02','17:22','So where is the leader of the free world? President Obama has picked out a place for himself among the spectator seats. From there, speaking of and to Iran, he comments that \"The world is watching.\" But while he has \"deep concerns,\" especially about the violence he\'s been observing on television, he sees no gain in \"meddling in Iranian elections.\"\r\n\r\nA cynic might infer that Obama is simply waiting for the protesters to be cleared out of the way so he can carry on with his dreams of extending a hand to cut deals with the dissent-crushing, terror-drunk, uranium-loving godfathers of Tehran. More generously, one might wonder if Obama really believes Iran\'s people have the best chance of defanging their own despots if unarmed protesters and armed state security forces are left to hash out among themselves who\'s in charge.',0,'cibech',0,13658),
 (3,'200908030802132500000300','Test3','2009-08-03','08:02','Any depiction or recreation of real world locations, entities, businesses, or organizations is not intended to be or imply any sponsorship or endorsement of this game by such party or parties. Produced under license of Ferrari Spa. FERRARI',0,'cibech',0,15897),
 (1,'200906030633141400000101','测试一','2009-06-03','06:33','伊朗总统选举争议引发的街头抗争17日进入第5天。败选的前总理米尔·侯赛因·穆萨维支持者不顾政府禁令，17日晚继续在首都德黑兰等地举行示威活动。同一天，伊朗政府抗议美国“干涉”伊朗国内事务，美国国务院对此予以否认。 “无声示威”哀悼死伤者穆萨维17日通过个人网站，呼吁支持者把18日当作“哀悼日”，向几天前死于街头冲突的死伤民众及其家人表示哀悼之情。',0,'cibech',1,9654),
 (2,'200906040802121200000201','测试二','2009-06-04','08:02','其中，允许“经批准，通过以聘代评的方式取得中级及以上专业技术职务任职资格的，提供单位的聘书”也可以；在激励条件中只要符合条件的就不受职称这一条的限制。实施细则中为适应部分未实行专业技术职务或职业资格制度的企业中就业、创业人员的实际情况，设定了以薪酬、纳税、或创造就业岗位的实际水平，替代申办条件中级专业技术职务和职业资格的要求，即薪酬及纳税或解决本市就业贡献达到一定标准的就业、创业人员可不受职称（职业资格)限制。激励条件中还注明，“按个人在本市直接投资（或投资份额）计算，最近连续三个纳税年度内累计缴纳总额及每年最低缴纳额达到本市规定标准的，或者连续3年聘用本市员工人数达到规定标准的”，这只是对一部分可能不符合以职称等为衡量标准的一种补充，人才是多样的，在上海投资又缴纳一定的税收和创造就业岗位也是人才，它只是对少数人，谈不上花300万元买了一个户口，这是对其贡献的一种认定方法。其中，连续3年平均每年聘用本市员工100人及以上，标准有些高，但与连续三个纳税年度平均每年纳税额在100万元及以上是两者取一，就好多了。体现了“不惟学历、不惟职称、不惟资历、不惟身份，海纳百川聚人才”。',0,'cibech',1,12541),
 (3,'200908050802565600000301','测试三','2009-08-05','08:02','据韩联社报道，劳拉·凌的姐姐丽莎·凌17日上午做客ABC广播节目表示：“朝鲜当局于上周宣判她们12年劳改后，再也没有听到任何消息，感到很担心。” 美国媒体报道称，2名女记者的家属通过声明表示：“对朝鲜当局公开细节表示感谢。无论她们承认的嫌疑是什么，我们都在此道歉。真心希望朝鲜当局拿出同情心，将尤娜·李和劳拉·凌送回家人',0,'cibech',1,19658),
 (1,'200905020802225600000102','テスト1','2009-05-02','08:02','1955年の森永ヒ素ミルク中毒事件では粉ミルクにヒ素が混入したことが原因で、多数の死者を出した。この場合は急性砒素中毒である。\r\n\r\n2004年には英国食品規格庁がヒジキに無機ヒ素が多く含まれるため食用にしないよう英国民に勧告した。これに対し、日本の厚生労働省はヒジキに含まれるヒ素は極めて微量であるため、一般的な範囲では食用にしても問題はないという見解を出している[4]。\r\n\r\nまた、土壌汚染対策法において、ヒ素およびその化合物は第2種特定有害物質に定められている。',0,'cibech',2,2541),
 (4,'200910051722256500000401','测试四','2009-10-05','17:22','新华网合肥6月22日电（记者 熊润频、葛如江）记者从安徽省检察院获悉，安徽省市县三级检察机关目前已经介入安徽凤阳6·21爆炸事故的调查，将对事故背后是否存在渎职犯罪行为进行彻查。\r\n\r\n21日凌晨3时许发生在安徽凤阳境内的晶鑫矿业有限公司的爆炸事故，目前共导致59人伤亡，其中死亡16人，重伤3人，轻伤40人。据初步认定，该事故系企业法人私藏炸药所致。\r\n\r\n据安徽省检察院反渎职侵权局副局长吴友长',0,'cibech',1,23561),
 (5,'201006040802121600000501','测试五','2010-06-04','08:02','记者从事故处理善后小组了解到，凤阳县政府本着以人为本的原则，对于伤亡家属的赔付将按照有关规定的最高标准赔付，预计平均不低于25万元。目前善后小组已与15个遇难家属取得了联系，正在商谈具体理赔事宜，家属情绪稳定。目前事发地区民情、社情稳定。\r\n\r\n　　截至目前，21日发生在安徽凤阳境内的晶鑫矿业有限公司的爆炸事故，共导致59人伤亡，其中死亡16人，重伤3人，轻伤40人。 ',0,'cibech',1,26895);
