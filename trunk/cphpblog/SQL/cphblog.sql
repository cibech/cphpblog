...
INSERT INTO `tm_post` (`i_postid`,`s_posturi`,`s_posttitle`,`dt_postdate`,`c_posttime`,`tb_post`,`tn_delflag`,`s_user`) VALUES 
 (1,'200906027433','实验性质的标题','2009-06-02','1622','我希望我能看到一片文章哦',0,'cibech'),
 (2,'200906027569','这是第二篇','2009-06-02','1722','嗯，这是我的第二篇文章',0,'cibech'),
 (3,'200906027630','瑞穂財団は経済の危機です','2009-06-03','0802','聞いたの通り、いまはきんきょう時代です.<p>これはpのログです</p><b>Bのテストです</b>',0,'cibech');
