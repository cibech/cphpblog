...
CREATE TABLE `tm_comments` (
  ...
  `s_user` varchar(20) NOT NULL COMMENT 'User of the comment',
...
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Comments of posts';
...
INSERT INTO `tm_comments` (`i_postid`,`i_comment_id`,`s_user`,`dt_postdate`,`c_posttime`,`t_comment`,`tn_isreply`,`i_repid`,`tn_delflag`,`tn_lang`,`tn_isowner_only`) VALUES 
 (1,1,'cibech','2009-06-14','15:33','これはコメントですよ',0,NULL,0,2,0),
 (1,2,'cibech','2009-06-14','15:34','这是中文评论',0,NULL,0,1,0);
